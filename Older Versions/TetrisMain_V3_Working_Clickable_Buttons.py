    ...
    while running_state:
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                exit()
        # Menu Buttons
        playButton = main_menu_buttons("Play",(255,255,255), (96, 169, 23), (50, 75, 10), 0, 200, say, 210, 125)
        playButton.drawButton(main_window, 8, True, True, (45, 118, 0))
        helpButton = main_menu_buttons("Help", (255,255,255), (250, 104, 0), (125, 50, 0), 0, 375, say, 210, 125)
        helpButton.drawButton(main_window, 8, True, True, (199, 53, 0))
        exitButton = main_menu_buttons("Exit", (255,255,255), (229, 20, 0), (115, 10, 0), 0, 550, say, 210, 125)
